...
import { room7 } from "./scenes/room7.js"
...
async function main() {
  ...
  const room7Data = await (await fetch("./maps/room7.json")).json();
...
k.scene("room6", (previousSceneData) => {
    room6(k,room6Data, previousSceneData)
});

k.scene("room7", (previousSceneData) => {
    room7(k,room7Data, previousSceneData)
});
